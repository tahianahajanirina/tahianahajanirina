...
**MLOps & Infra**
`Docker` `Kubernetes` `FastAPI` `Prometheus` `Grafana` `GitHub Actions`

**Data Engineering**
`PostgreSQL` `LocalStack` `AWS S3`

---

## 📫 Contact

- 🎓 Télécom Paris — Mastère Spécialisé IA & Data
- 💼 [LinkedIn](https://linkedin.com/in/tahiana-hajanirina)
- 📧 tahiana.hajanirina@outlook.com
